module github.com/orhayat/dynamodb-go/examples/simple-example
...
require (
	...
	github.com/orhayat/dynamodb-go v0.0.0-00010101000000-000000000000
)
...
replace github.com/orhayat/dynamodb-go => ../../
